...
- Releases: `CHANGELOG.md` is generated by the release workflow from Conventional Commits (it prepends a
  section per tag); write human release notes in the GitHub Release body, not in the file.
