...
description: State of the Daggerheart character importer as of 2026-09-06 (v0.1.0 released) — what works, what Danny has tried, what is next; the resume point for the next session
metadata:
  type: project
---
