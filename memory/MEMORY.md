...
- [Project status](project-foundry-import-status.md) — what works as of 2026-09-06 evening (v0.3.0), what Danny tried, what's next
- [Verify in live Foundry](feedback-verify-in-live-foundry.md) — real bugs only showed in the running world; use selfTest + Chrome tools after foundry/app changes
- [Release workflow research](feedback-release-workflow-research.md) — dannysmodule CI is not a reference; use League template + wiki; verify releases by download
